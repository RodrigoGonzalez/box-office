...
def main():
	...
	adadelta = [0.5, 0.45, 0.4]
	for delta in adadelta:
		tokenizer2, model2 = train_model("gated_recurrent", delta)
...
if __name__ == "__main__":
    # tokenizer1, model1, tokenizer2, model2 = main()
    tokenizer2, model2 = main()
